      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-dark-400">Série: {anoMin} - {anoMax}</p>
          </div>
          ...
          <div className="space-y-3 flex flex-col items-start md:items-end">
            ...
            >
              <img
                ...
                alt="Avner Gomes"
                className="w-8 h-8 rounded-md object-contain opacity-80 group-hover:opacity-100 transition-opacity"
              />
